...
test.describe('API Матч-центр', () => {
  test('API Матч-центр. Приходит массив матчей GET /matches/center', { tag: ['@API'] }, async ({ api }) => {
  ...
  test('API Матч-центр по видам спорта. Приходит массив матчей GET /matches/center', { tag: ['@API'] }, async ({ api }) => {
